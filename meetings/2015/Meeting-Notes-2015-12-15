# Documentation Interest Group Agenda - December 15th, 2015 3:00 ET
...
* Update Contribute page for 1.7 documentation? Who can take this on?
...
* If approved, Robin will post updated terms to Github.

## 5) Documentation for Developers
* Does this work: https://groups.google.com/forum/#!topic/islandora-docs/k3PSVnSMrpA 
* Dan to create categories? (see: https://groups.google.com/forum/#!topic/islandora-docs/k3PSVnSMrpA)

## 6) Committers' Calls
* Need to appoint new DIG rep.

## 7) Next meeting & meeting time for 2016
