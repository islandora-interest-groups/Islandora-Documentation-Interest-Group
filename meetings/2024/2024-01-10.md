...
- Community announcements:
  - (from TAG) Willow no longer with born-digital, not involved in Islandora work anymore
  - Kirsta's part-time position ended; work for new Islandora staff member under way (precise role?)
- Think about trimming the DIG workign agenda; add parking lot document
  - put a pin in doc sprint planning, start fresh for new year
  ...
  - Survey: keep on backburner
- 2024 Documentation prios discussion: Follow work to consolidate installation methods/deprecating ISLE-DC; documenting migration pathways between installation flavours; keep readme files and documentation in sync; documenting Docker commands in more detail, possibly making 'make' files optional
