# Documentation Interest Group — July 10th, 2024 — 2:00 PM Eastern
...
- Community announcements:
    - June Open Meeting (06/25): Islandora Interest Group report out, recap the last 4-6 months
    - Conference frequency set at every other year
- Start draft of content for open meeting DIG report
  - base slide(s) on older DIG presentations: https://docs.google.com/presentation/d/14FELm9RCwz3PjDTavalIRmWfJJwPXs5u5Pi0tItjbPg/edit#slide=id.p
      - small group
      - thank contribututors for PRs
      - day-to-day work
- Give feedback to Josh on his proposed additions:
    - Older Google doc draft
    - https://docs.google.com/document/d/1NmbopEgFhnhrOqlCVcG-ERM5glg_Lqbo51d7PrPG62o/edit#heading=h.8qxcbbxnrn1y
    - Latest oull requests
        - https://github.com/Islandora/documentation/pull/2317
        - https://github.com/Islandora/documentation/pull/2313
        - https://github.com/Islandora/documentation/pull/2311
        - https://github.com/Islandora/documentation/pull/2319
        - https://github.com/Islandora/documentation/pull/2312 
    - Josh ready to create different PRs for documentation changes/new doc; possibly using meta-issue to bind them together
    - Goal: Making documentation for site template as robust as possible, ultimately giving TAG chance to phasing out Isle-DC
    - Stop commenting on Google Doc, focus on PRs instead
...
- Look into cookbook recipes for Islandora 2 that could be moved to offical docs
    ...
    - Actions
        - Discuss next actions: Use June meeting time (June 12th) to review Cookbook/moved documentation
