# Documentation Interest Group — November 13th, 2024 — 2:00 PM Eastern
...
- Community announcements:
    - ICC planning to facilitate IG cross-talk during November Open Meeting
- Florida Virtual Campus has created extensive in-house user documentation for Islandora 2, might be able to share in December
...
- Look into cookbook recipes for Islandora 2 that could be moved to offical docs
    ...
    - Actions
        - [October 2024]: Message mailing list about planned retirement of Islandora Cookbook repo
        - Discuss next actions: Use 2nd half of September meeting to review Cookbook/moved documentation
...
- [September 2024]: Review Rosie's module-by-module documentation on wiki; revisit documentation menu structure to find home for it
