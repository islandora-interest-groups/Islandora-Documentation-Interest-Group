# Documentation Interest Group — August 14th, 2024 — 2:00 PM Eastern
...
- Questions by Kestrel
    - Adding role tags to documentation, e.g. user, dev, admin? Work towards this happend during a documentation audit a few years ago; nice to have, but requires time/person power
    - Recipes: specify what is supported and what comes out of the box/needs installation
