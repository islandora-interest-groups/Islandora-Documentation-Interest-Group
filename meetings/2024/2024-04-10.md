# Documentation Interest Group — April 10th, 2024 — 2:00 PM Eastern
...
- Community announcements:
    ...
    - April Open Meeting: metadata, inst. repositories, show-and-tell
...
- Metadata Interest Group, review of Starter Site fields
    ...
    - Think of next actions
        - Lina and Yamil plan to create issue to integrate MIG spreadsheet with documentation (https://drive.google.com/drive/u/0/folders/1kTAHFcjNnipXHYQSkwgoQsgBPLYBm_1y --> https://docs.google.com/spreadsheets/d/1N37GSwiDl_DSH9-n3BhWLUtjZohOg2udGJJlnZ8BmWQ/edit#gid=0) --> done, linked to PR 2295
        - set up page for metadata documentation parallel to https://islandora.github.io/documentation/user-documentation/metadata/
    - PR available: https://github.com/Islandora/documentation/pull/2295
