...
- Yamil planning to work on onboarding documentation for DIG
- At the tech call it was suggested we should document the "link headers" feature in Islandora. Need a volunteer to create an issue, and then we need to write the documentation
...
- Florida Virtual Campus has created extensive in-house user documentation for Islandora 2
    ...
    - Possible action items for DIG? Can we reuse content for official documentation?
    - Keep on agenda to discuss with FLVC staff
