# Documentation Interest Group — April 9th, 2025 — 2:00 PM Eastern
...
- Community announcements:
    ...
    - Virtual use-a-thon?
- Aside: ISLE site-template instructions, Josh thankful for specific pointers to pain points/ things that don't work during an installation
- Yamil submitted proposal for a DIG lighning talk, to give info abotu DIG and try to recruit new members
- At the tech call it was suggested we should docuemnt the "link headers" feature in Islandora. Need a volunteer to create an issue, adn then we need to write the documentation
...
- Review open documentation issues: https://github.com/Islandora/documentation/issues?q=is%3Aopen+is%3Aissue+label%3A%22Type%3A+documentation%22
    - [February 2025] Checked for untagged/unlabeled issues with '[DOCS]' in the title, applied label
    - [KEEP ON AGENDA]
...
- Updates/Highlights for Leadership Group meeting
    - Discussed FLVC documentation, solliciting feedback; went over open PRs, issues, recent commits; discussed working meeting to finish work on Cookbook; brainstormed landing page for different installation methods
    - [KEEP ON AGENDA]
