...
- Do we need better docs for uprgading individual Drupal modules?
  - this came up on slack and then the tech call
  - It was mentioned tht the current isle-dc and isle-site-template docs between them have enough info
